...
Cusack \parencite*[20]{Cusack10} gives an exemplary list
...
purported world-view elucidated profound truths.
...
its function are imperceivable without
...
One of Terry A. Davis' intended purposes for TempleOS was
...
Furthermore, although Erik Davis suggested that the motivation behind
world building efforts is a `longed-for mastery of matter',
and Berger's conception of world building was as an effort to project
human order into the cosmos,
both can be identified in TempleOS' oracle.
...
project constructed in a pragmatic effort to access that evidence.
