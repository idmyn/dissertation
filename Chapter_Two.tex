...
this phenomenon of apparent combat not really actually being combat
was only possible ``with some degree of \textit{meta-communication}'',
...
If this signal was not exchanged some way or other it would result in \textbf{violence}...
